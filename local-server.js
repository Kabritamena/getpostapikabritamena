...
app.post('/data', (req, res) => {
  const data = req.body;
  connection.query('INSERT INTO tokens SET ?', data, (err, result) => {
    if (err) {
      console.error(err);
